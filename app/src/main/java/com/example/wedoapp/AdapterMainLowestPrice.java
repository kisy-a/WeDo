...
public class AdapterMainLowestPrice extends RecyclerView.Adapter<AdapterMainLowestPrice.HolderViewLowestPrice> {

    private Context context;
    private ArrayList<Model_Service> LowestPriceList;

    public AdapterMainLowestPrice(Context context, ArrayList<Model_Service>lowestPriceList){
        this.context = context;
        this.LowestPriceList = lowestPriceList;
    }
    @NonNull
    @Override
    public AdapterMainLowestPrice.HolderViewLowestPrice onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.buyer_suggested_service,parent,false);
        return new AdapterMainLowestPrice.HolderViewLowestPrice(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterMainLowestPrice.HolderViewLowestPrice holder, int position) {
        Model_Service model_service = LowestPriceList.get(position);
        ...
        holder.Suggested_SerItem_Title.setText(STitle);
    ...
    private void loadServiceReview(Model_Service model_service, AdapterMainLowestPrice.HolderViewLowestPrice holder) {
        String serviceID = model_service.getSID();
    ...
    public class HolderViewLowestPrice extends RecyclerView.ViewHolder{
        ...
        public HolderViewLowestPrice(@NonNull View itemView) {
            super(itemView);
