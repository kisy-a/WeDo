...
public class ServiceCategoryDress extends AppCompatActivity {

    private TextView tv_NoWService, tv_NoWService2;
    private ImageView iv_NoWService;
    private ImageButton WritingBackToMainServiceList, FilterButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_dress);
        ...
        WritingBackToMainServiceList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent Data2Home = new Intent(ServiceCategoryDress.this, BuyerHome.class);
        ...
        FilterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myEdit.putString("ServiceCat", "ServiceCategoryDress");
                myEdit.apply();
                Intent Data2Filter = new Intent(ServiceCategoryDress.this, FilterServiceCategory.class);
    ...
    private void loadServices() {
        ...
        databaseReference.orderByChild("SCategory").equalTo("Dress Tailoring").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!s2.equals("") && !s3.equals("")) {
                    ...
                    //setup adapter
                    adapterServiceItem = new AdapterServiceItem(ServiceCategoryDress.this, ServiceItemList);
                    //set adapter
    ...
    public void filterList(String minPriceString, String maxPriceString) {
        ...
        //setup adapter
        adapterServiceItem = new AdapterServiceItem(ServiceCategoryDress.this, filteredList);
        //set adapter
        recyclerViewWritingItemList.setAdapter(adapterServiceItem);
    ...
    private void sortListByPriceDescending(ArrayList<Model_Service> ServiceItemList) {
        ...
        Collections.sort(ServiceItemList, new ServiceCategoryDress.SortByPrice());
    }
    private void sortListByPriceAscending(ArrayList<Model_Service> ServiceItemList) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Collections.sort(ServiceItemList, new ServiceCategoryDress.SortByPrice().reversed());
        }
    }
    ...
    private void sortListByRecent(ArrayList<Model_Service> ServiceItemList) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Collections.sort(ServiceItemList, new ServiceCategoryDress.SortByRecent().reversed());
        }
    }
