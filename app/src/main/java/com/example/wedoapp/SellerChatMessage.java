...
public class SellerChatMessage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_chat_message);
        ...
        BottomNavigationView buyerNV = findViewById(R.id.sellerNavigation);
        //set Selected
        buyerNV.setSelectedItemId(R.id.sellerMessage);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds: snapshot.getChildren()){
                    ...
                    //setup adapter
                    adapterChat = new AdapterChat(SellerChatMessage.this, UserList);
