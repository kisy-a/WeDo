...
public class ServiceCategoryCatering extends AppCompatActivity {

    private TextView tv_NoMService, tv_NoMService2;
    private ImageView iv_NoMService;

    private ImageButton LifestyleBackToMainServiceList, FilterButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_catering);
        ...
        LifestyleBackToMainServiceList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent Data2Home = new Intent(ServiceCategoryCatering.this, BuyerHome.class);
        ...
        FilterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myEdit.putString("ServiceCat", "ServiceCategoryCatering");
                myEdit.apply();
                Intent Data2Filter = new Intent(ServiceCategoryCatering.this, FilterServiceCategory.class);
    ...
    private void loadServices() {
        ...
        databaseReference.orderByChild("SCategory").equalTo("Catering Services").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!s2.equals("") && !s3.equals("")) {
                    ...
                    //setup adapter
                    adapterServiceItem = new AdapterServiceItem(ServiceCategoryCatering.this, ServiceItemList);
                    //set adapter
    ...
    public void filterList(String minPriceString, String maxPriceString) {
        ...
        //setup adapter
        adapterServiceItem = new AdapterServiceItem(ServiceCategoryCatering.this, filteredList);
        //set adapter
        recyclerViewLifestyleItemList.setAdapter(adapterServiceItem);
    ...
    private void sortListByPriceDescending(ArrayList<Model_Service> ServiceItemList) {
        ...
        Collections.sort(ServiceItemList, new ServiceCategoryCatering.SortByPrice());
    }
    private void sortListByPriceAscending(ArrayList<Model_Service> ServiceItemList) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Collections.sort(ServiceItemList, new ServiceCategoryCatering.SortByPrice().reversed());
        }
    }
    ...
    private void sortListByRecent(ArrayList<Model_Service> ServiceItemList) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Collections.sort(ServiceItemList, new ServiceCategoryCatering.SortByRecent().reversed());
        }
    }
