...
public class ServiceCategoryFlower extends AppCompatActivity {

    private TextView tv_NoMService, tv_NoMService2;
    private ImageView iv_NoMService;

    private ImageButton FlowerBackToMainServiceList, FilterButton;
    ...
    private EditText FlowerSearch;
    private FirebaseAuth auth;
    private String s1, s2,s3,s4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_item_flower);
        ...
        FlowerSearch = findViewById(R.id.FlowerSearch);
        FlowerBackToMainServiceList = findViewById(R.id.FlowerBackToMainServiceList);
        ...
        FlowerSearch.addTextChangedListener(new TextWatcher() {
            @Override
        ...
        FlowerBackToMainServiceList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Data2Home = new Intent(ServiceCategoryFlower.this, BuyerHome.class);
        ...
        FilterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myEdit.putString("ServiceCat", "ServiceCategoryFlower");
                myEdit.apply();
                Intent Data2Filter = new Intent(ServiceCategoryFlower.this, FilterServiceCategory.class);
    ...
    private void loadServices() {
        ...
        databaseReference.orderByChild("SCategory").equalTo("Flowers").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!s2.equals("") && !s3.equals("")) {
                    ...
                    //setup adapter
                    adapterServiceItem = new AdapterServiceItem(ServiceCategoryFlower.this, ServiceItemList);
                    //set adapter
                ...
                if(ServiceItemList.isEmpty()){
                    ...
                    FlowerSearch.setVisibility(View.GONE);
                }
    ...
    public void filterList(String minPriceString, String maxPriceString) {
        ...
        //setup adapter
        adapterServiceItem = new AdapterServiceItem(ServiceCategoryFlower.this, filteredList);
        //set adapter
        recyclerViewLifestyleItemList.setAdapter(adapterServiceItem);
    ...
    private void sortListByPriceDescending(ArrayList<Model_Service> ServiceItemList) {
        ...
        Collections.sort(ServiceItemList, new ServiceCategoryFlower.SortByPrice());
    }
    private void sortListByPriceAscending(ArrayList<Model_Service> ServiceItemList) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Collections.sort(ServiceItemList, new ServiceCategoryFlower.SortByPrice().reversed());
        }
    }
    ...
    private void sortListByRecent(ArrayList<Model_Service> ServiceItemList) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Collections.sort(ServiceItemList, new ServiceCategoryFlower.SortByRecent().reversed());
        }
    }
