...
public class AdapterBuyerViewReview extends RecyclerView.Adapter<AdapterBuyerViewReview.HolderBuyerReview> {

    private Context context;
    private ArrayList<Model_Rating> BuyerReviewList;

    public AdapterBuyerViewReview(Context context, ArrayList<Model_Rating>buyerReviewList){
        this.context = context;
        this.BuyerReviewList = buyerReviewList;
    }
    @NonNull
    @Override
    public AdapterBuyerViewReview.HolderBuyerReview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.review_buyer,parent,false);
        return new AdapterBuyerViewReview.HolderBuyerReview(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterBuyerViewReview.HolderBuyerReview holder, int position) {
        Model_Rating model_rating = BuyerReviewList.get(position);
    ...
    private void loadUserDetail(Model_Rating model_rating, HolderBuyerReview holder) {
    ...
    public class HolderBuyerReview extends RecyclerView.ViewHolder{
        ...
        public HolderBuyerReview(@NonNull View itemView) {
            super(itemView);
