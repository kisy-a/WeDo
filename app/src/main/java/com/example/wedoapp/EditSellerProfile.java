...
public class EditSellerProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onBackPressed();
                //Intent backToBuyerAcc = new Intent (EditProfile.this , BuyerAccount.class);
        ...
        if (image_uri == null) {
            ...
            databaseReference.child(auth.getUid()).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    ...
                    Intent intent2acc = new Intent(EditSellerProfile.this, SellerAccount.class);
    ...
    private void checkUser() {
        ...
        if(user == null){
            Intent intentToMain = new Intent(EditSellerProfile.this,MainActivity.class);
